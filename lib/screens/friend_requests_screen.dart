...
class FriendRequestsScreen extends StatefulWidget {
  ...
  const FriendRequestsScreen({super.key, required this.childId});
...
class _FriendRequestsScreenState extends State<FriendRequestsScreen> {
  ...
  Future<void> _acceptRequest(String pairId) async {
    ...
    try {
      ...
      _showAppSnackBar('أصبحتم أصدقاء الآن! 🎉');
    } catch (e) {
      if (!mounted) return;
  ...
  Future<void> _declineRequest(String pairId) async {
    ...
    try {
      ...
      _showAppSnackBar('تم رفض طلب الصداقة');
    } catch (e) {
      if (!mounted) return;
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          stream: FirebaseFirestore.instance
              ...
              .where('receiverId', isEqualTo: widget.childId)
              .snapshots(),
          builder: (context, snapshot) {
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              return const Stack(
                children: [
                  Positioned.fill(child: _RequestsBackground()),
              ...
              return const Stack(
                children: [
                  ...
                  _MessageView(
                    ...
                    message: 'ستظهر طلبات أصدقائك هنا',
                  ),
                ],
              );
            }
            ...
            return Stack(
              children: [
                const Positioned.fill(
                  child: IgnorePointer(child: _RequestsBackground()),
                ),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return FutureBuilder<Map<String, dynamic>?>(
                      ...
                      builder: (context, profileSnapshot) {
                        ...
                        final bool processing = _processingPairId == request.id;
...
class _RequestsWelcomeCard extends StatelessWidget {
  ...
  const _RequestsWelcomeCard({required this.requestCount});
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                height: 110,
                decoration: BoxDecoration(
                  color: const Color(0xFFFFD9E2).withOpacity(0.38),
                  shape: BoxShape.circle,
                ),
              ),
            ),
                ...
                Expanded(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      foregroundColor: const Color(0xFF817987),
                      backgroundColor: const Color(0xFFFAF8FB),
                      padding: const EdgeInsets.symmetric(vertical: 12),
                      side: BorderSide(color: purple.withOpacity(0.10)),
                      shape: const StadiumBorder(),
                    ),
                    child: const Text(
                      'رفض',
...
class _MessageView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bool isError = icon == Icons.error_outline_rounded;
    ...
    return Stack(
      children: [
        ...
        Positioned(
          top: 575,
          right: -50,
          child: _circle(125, const Color(0xFFFFDCE3).withOpacity(0.23)),
        ),

        Positioned(
          bottom: 40,
          left: 38,
          child: _circle(20, const Color(0xFFD5BFE9).withOpacity(0.33)),
        ),
      ],
    );
  }
...
class _RequestBunny extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const details = Color(0xFF4D3855);
    ...
    return Stack(
      ...
      children: [
          ...
          child: Transform.rotate(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color(0xFFDCC9E8)),
              ),
              child: const Center(
                child: Icon(
                  Icons.favorite_rounded,
        ...
        // Ears
        Positioned(top: 0, right: 23, child: _BunnyEar(color: face)),

        Positioned(top: 0, left: 23, child: _BunnyEar(color: face)),
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: const Stack(
              children: [
                // Eyes
                Positioned(top: 20, right: 14, child: _BunnyEye()),
                Positioned(top: 20, left: 14, child: _BunnyEye()),

                // Nose
                Positioned(top: 28, left: 26, child: _BunnyNose()),

                // Smile
                Positioned(top: 34, left: 22, child: _BunnySmile()),
              ],
            ),
          ),
        ),

        // Cheeks outside const stack
        Positioned(top: 60, right: 28, child: _BunnyCheek()),

        Positioned(top: 60, left: 28, child: _BunnyCheek()),
      ],
    );
  }
}
...
class _WaitingRequestBunny extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        ...
        // One normal ear
        Positioned(top: 5, right: 30, child: _BunnyEar(color: face)),

        // One tilted ear - gives waiting/curious expression
        Positioned(
          top: 14,
          left: 21,
          child: Transform.rotate(angle: -0.48, child: _BunnyEar(color: face)),
        ),
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                const Positioned(top: 22, right: 15, child: _BunnyEye()),

                const Positioned(top: 22, left: 15, child: _BunnyEye()),

                const Positioned(top: 31, left: 29, child: _BunnyNose()),

                // Tiny neutral/cute smile
                Positioned(
                  top: 39,
                  left: 25,
                  child: Container(
                ...
                Positioned(top: 36, right: 7, child: _BunnyCheek()),

                Positioned(top: 36, left: 7, child: _BunnyCheek()),
              ],
            ),
          ),
        ),
  ...
  Widget _dot(double size) {
    return Container(
      ...
      height: size,
      decoration: BoxDecoration(
        color: const Color(0xFF9A73B8).withOpacity(0.45),
        shape: BoxShape.circle,
      ),
    );
  }
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          top: 7,
          right: 29,
          child: Transform.rotate(angle: 0.18, child: _BunnyEar(color: face)),
        ),
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      border: Border(
                        bottom: BorderSide(color: details, width: 1.7),
                      ),
                    ),
                  ),
                ),
                ...
                const Positioned(top: 32, left: 29, child: _BunnyNose()),

                // Small round mouth — concerned, not angry
                Positioned(
                  top: 41,
                  left: 29,
                  child: Container(
                    ...
                    height: 7,
                    decoration: BoxDecoration(
                      border: Border.all(color: details, width: 1.2),
                      shape: BoxShape.circle,
                    ),
                  ),
                ),

                Positioned(top: 37, right: 8, child: _BunnyCheek()),

                Positioned(top: 37, left: 8, child: _BunnyCheek()),
              ],
            ),
          ),
        ),
...
class _BunnyEar extends StatelessWidget {
  ...
  const _BunnyEar({required this.color});
    ...
    return Container(
      ...
      child: Center(
        child: Container(
          ...
          height: 24,
          decoration: BoxDecoration(
            color: const Color(0xFFFFA1B7).withOpacity(0.52),
...
class _BunnySmile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        border: Border(
          bottom: BorderSide(color: Color(0xFF4D3855), width: 1.4),
        ),
        borderRadius: BorderRadius.only(
